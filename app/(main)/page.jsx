  ...
  return (
    <main className="flex h-screen w-full flex-col bg-[#2E2E48] md:flex-row">
      ...
      <div className="custom-grid-rows border-bg-[#3A3958] grid h-full min-w-[500px] grid-cols-1 gap-4 overflow-y-auto rounded-3xl bg-[#3A3958] text-violet-200 md:grid-cols-2 lg:w-3/4 lg:grid-cols-4">
        <div className="row-span-1 ml-8 mt-12 whitespace-nowrap text-4xl">
        ...
        <div className="col-span-1 row-span-1 mx-6 mb-4 rounded-3xl bg-[#2E2E48] md:col-span-2 lg:ml-6">
            2
        </div>

        <div className="col-span-1 row-span-1 mx-6 mb-4 rounded-3xl bg-[#2E2E48] md:col-span-2 lg:mr-6">
            3
        </div>
      </div>
      <div>
